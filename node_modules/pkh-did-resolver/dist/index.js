 ...
 */ /* eslint-disable  @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-call, @typescript-eslint/require-await */ import { AccountId } from 'caip';
...
function toDidDoc(did, accountId) {
    const { namespace } = AccountId.parse(accountId).chainId;
    ...
    // nothing to do here
        ...
        doc['@context'][1].TezosMethod2021 = 'https://w3id.org/security#TezosMethod2021' // eslint-disable-line prettier/prettier
        ;
...
export function getResolver() {
    return {
        // @ts-ignore
        pkh: async (did, parsed, // @ts-ignore
        r, options)=>{
